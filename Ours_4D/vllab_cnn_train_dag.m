...
for epoch=start+1:opts.numEpochs
  ...
  %end
  %imdb_this = imdb;
  %imdb_this.images.filename = imdb_this.images.filename(data);
  %imdb_this.images.img = imdb_this.images.img(data);
  %imdb_this.images.set = imdb_this.images.set(data);
  %opts.train = find(imdb_this.images.set==1);
  %opts.val = find(imdb_this.images.set==2);
